...
<div id="aboutsect">
    ...
    <div class="aboutsect-content">
        <img src="assets/images/about-1.webp" class="aboutsect-image" alt="Sample Summer Top Crochet Kit Contents">
        ...
        <img src="assets/images/about-2.webp" class="aboutsect-image" alt="Sample Scrunchie Crochet Kit Complete">
    </div>
</div>
