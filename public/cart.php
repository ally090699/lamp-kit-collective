...
<div class='cart-container'>
    <div class='cart'>
                ...
                <div class='cart-product'>
                    ...
                    <div>
                        ...
                        <div class='cart-product-section'>
                            <p class='cart-price'>Price: $<?php echo htmlspecialchars(number_format($product['price'],2)); ?></p>
                            ...
                            <p class='cart-subtotal'>Subtotal: $<?php echo htmlspecialchars(number_format($product_subtotal,2)); ?></p>
                        </div>
                    </div>
                </div>
        ...
        $hst=$cart_subtotal*0.13;
        $shipping_fee=3.99;
        $grand_total=$cart_subtotal + $hst + $shipping_fee;
        ?>
    </div>
    <div class="cart-details">
        <p class="cart-details-header">Subtotal: $<?php echo htmlspecialchars(number_format($cart_subtotal,2)); ?></p>
        <p class="cart-details-header">HST (13%): $<?php echo htmlspecialchars(number_format($hst,2)); ?></p>
        <p class="cart-details-header">Shipping Fee: $<?php echo htmlspecialchars(number_format($shipping_fee,2)); ?></p>
        <p class="cart-details-header">Total: $<?php echo htmlspecialchars(number_format($grand_total,2)); ?></p>
